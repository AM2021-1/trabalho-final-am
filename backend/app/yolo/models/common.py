...
from yolo.utils.datasets import exif_transpose, letterbox
from yolo.utils.general import (LOGGER, check_requirements, check_suffix, colorstr, increment_path, make_divisible,
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=True):
        ...
        if jit:  # TorchScript
            ...
            from yolo.models.experimental import attempt_load  # scoped to avoid circular import
